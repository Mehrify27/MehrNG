...
* **🎨 طراحی سه بعدی و مدرن (3D UI):** باکس‌های سرور با سایه‌زنی‌های طبیعی و نشان‌های فرورفته سه بعدی طراحی شدند.
...
👉 **[GitHub Releases / بخش ریلیزها](https://github.com/Mehrify27/MehrNG/releases)**
